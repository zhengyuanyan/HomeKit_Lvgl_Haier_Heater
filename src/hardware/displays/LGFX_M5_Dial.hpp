...
public:
    LGFX(void)
    {
        // --- SPI bus ---
        {
            ...
            cfg.pin_sclk = GPIO_NUM_6;
            cfg.pin_mosi = GPIO_NUM_5;
        ...
        {                                        // Set display panel control.
            ...
            cfg.pin_cs = GPIO_NUM_7;   // Pin number to which CS is connected (-1 = disable)
        ...
        {                                        // Set backlight control. (delete if not necessary)
            ...
            cfg.pin_bl = GPIO_NUM_9;     // pin number to which the backlight is connected
